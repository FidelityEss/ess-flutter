...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? HomePageWidget() : IntroSlider3Widget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          ...
          path: '/payslipTaxListPage',
          builder: (context, params) => PayslipTaxListPageWidget(),
        ),
        FFRoute(
          name: 'PayslipTaxPage',
          path: '/payslipTaxPage',
        ...
        FFRoute(
          ...
          path: '/timeAndAttendancePage',
          builder: (context, params) => TimeAndAttendancePageWidget(),
        ),
        FFRoute(
          name: 'FidelityCaresPage',
          path: '/fidelityCaresPage',
          builder: (context, params) => FidelityCaresPageWidget(),
        ),
        FFRoute(
          name: 'LogAQueryPage',
          path: '/logAQueryPage',
          builder: (context, params) => LogAQueryPageWidget(),
        ),
        FFRoute(
          name: 'ReportIncidentPage',
          path: '/reportIncidentPage',
          builder: (context, params) => ReportIncidentPageWidget(),
        ),
        FFRoute(
          name: 'EventsPage',
          path: '/eventsPage',
