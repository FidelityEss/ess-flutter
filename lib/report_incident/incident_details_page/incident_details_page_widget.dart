...
class IncidentDetailsPageWidget extends StatefulWidget {
  const IncidentDetailsPageWidget({
    Key? key,
    required this.id,
  }) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<IncidentsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<IncidentsRecord> incidentDetailsPageIncidentsRecordList =
            snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final incidentDetailsPageIncidentsRecord =
            incidentDetailsPageIncidentsRecordList.isNotEmpty
                ? incidentDetailsPageIncidentsRecordList.first
                : null;
                        ...
                        children: [
                          ...
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                32.0, 32.0, 32.0, 0.0),
                            child: Text(
                              incidentDetailsPageIncidentsRecord!.title,
                              style: FlutterFlowTheme.of(context)
                                  .titleMedium
                                  .override(
                                    fontFamily: 'Montserrat',
                          ...
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                32.0, 16.0, 32.0, 0.0),
                            child: Text(
                              incidentDetailsPageIncidentsRecord!.message,
                          ...
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                32.0, 0.0, 32.0, 0.0),
                            child: StreamBuilder<List<IncidentUpdateRecord>>(
                              stream: queryIncidentUpdateRecord(
                                parent: incidentDetailsPageIncidentsRecord
                                    ?.reference,
                              ),
                              builder: (context, snapshot) {
                                // Customize what your widget looks like when it's loading.
                                ...
                                List<IncidentUpdateRecord>
                                    listViewIncidentUpdateRecordList =
                                    snapshot.data!;
                                return ListView.builder(
                                  ...
                                  itemCount:
                                      listViewIncidentUpdateRecordList.length,
                                  itemBuilder: (context, listViewIndex) {
                                    final listViewIncidentUpdateRecord =
                                        listViewIncidentUpdateRecordList[
                                            listViewIndex];
                                    return Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                await IncidentUpdateRecord.createDoc(
                                        incidentDetailsPageIncidentsRecord!
                                            .reference)
                                    .set(createIncidentUpdateRecordData(
